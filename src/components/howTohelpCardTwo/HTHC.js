  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Your donation helps Warriorswithoutcause (WWC) provide education, healthcare, and opportunities to underserved communities. Every contribution makes a real difference—whether it's empowering women with skills, offering healthcare, or supporting a child's education. Join us in making a lasting impact and building a brighter, more equal future for all.
        </Typography>
        <Button
          sx={{
        ...
        >
          <img src={pay} alt="Pay icon" style={{ height: '20px', width: 'auto' }} />
          <Typography
            sx={{
              fontWeight: 400,
              fontSize: "16px",
